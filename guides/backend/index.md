...
| 你要确认的问题 | 对应规范 |
| --- | --- |
| 当前 backend 架构事实、模块/包边界、依赖方向与默认实现约束 | [development.md](${CLAUDE_PLUGIN_ROOT}/guides/backend/development.md) |
...
| Calibration 模式输出与代码示例校准规则 | [calibration-mode.md](${CLAUDE_PLUGIN_ROOT}/guides/backend/calibration-mode.md) |
