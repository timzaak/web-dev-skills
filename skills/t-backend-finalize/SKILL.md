...
description: Run backend finalization after backend acceptance by simplifying code, running clippy, formatting, full backend tests, exporting OpenAPI, and generating the frontend API client. Use when the user runs /t-backend-finalize with a feature name after backend acceptance is completed.
---
