...
- [ ] `backend/src/main/java/{{PROJECT_PACKAGE_PATH}}/health/HealthStatus.java`
- [ ] `backend/src/main/java/{{PROJECT_PACKAGE_PATH}}/web/HealthController.java`
- [ ] `backend/src/main/java/{{PROJECT_PACKAGE_PATH}}/web/ApiError.java`
...
- [ ] `backend/src/test/java/{{PROJECT_PACKAGE_PATH}}/web/HealthControllerTest.java`
