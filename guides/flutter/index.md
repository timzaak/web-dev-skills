...
| integration_test、设备测试与 Patrol 原生交互基础 | [integration-testing.md](${CLAUDE_PLUGIN_ROOT}/guides/flutter/integration-testing.md) |
| Patrol package/CLI、Android/iOS 原生 runner 与首个 smoke test 初始化 | [patrol-initialization.md](${CLAUDE_PLUGIN_ROOT}/guides/flutter/patrol-initialization.md) |
| 按用户故事组织的 Android Patrol 演示、真实 App 与数据边界 | [demo-testing.md](${CLAUDE_PLUGIN_ROOT}/guides/flutter/demo-testing.md) |
...
- `testing.md` 负责单元/widget 测试，`integration-testing.md` 负责普通集成与原生能力基础，Patrol 首次接入看 `patrol-initialization.md`，用户故事演示看 `demo-testing.md`。
- agent 文档只定义执行顺序、门禁和输出契约，不重新发明框架、路由、状态管理或测试规范。

## 官方核对基线

本规范最近按以下官方资料核对（2026-08-09）：
...
- Patrol 4.x 文档：[Install Patrol](https://patrol.leancode.co/documentation)、[Compatibility table](https://patrol.leancode.co/documentation/compatibility-table)、[Develop](https://patrol.leancode.co/cli-commands)、[Build and test bundling](https://patrol.leancode.co/cli-commands/build)、[Native automation usage](https://patrol.leancode.co/documentation/native/usage)
