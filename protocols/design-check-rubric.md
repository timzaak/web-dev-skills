...
- 主文档 §8 文件影响范围必须存在，表格包含 `文件 | 操作 | 说明` 三列（可含来源分端列），操作列使用 CREATE/MODIFY/DELETE，来源分端取值限于 backend/frontend/flutter/web-demo/flutter-demo/跨端（Demo 演示资产按交付端标 web-demo/flutter-demo），且全量覆盖各分端文档的文件影响表
