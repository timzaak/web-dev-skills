...
- `testing.md` 负责单元/widget 测试，`integration-testing.md` 负责普通集成与原生能力基础，用户故事演示看 `demo-testing.md`。
...
- Patrol 4.x 文档：[Install Patrol](https://patrol.leancode.co/documentation)、[Native automation usage](https://patrol.leancode.co/documentation/native/usage)
